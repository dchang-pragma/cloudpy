...
#  Set up the TensorFlow placeholders that get updated as we descend down the gradient; to receive data
...
# Initializing the variables # for Michelle's reference
